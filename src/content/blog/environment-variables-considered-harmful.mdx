...
<Footnote number={4}>
  <p>Note that I'm using `APP_ENV` despite `NODE_ENV` probably being a more conventional name in JavaScript apps. Both work, I just want this article to be as language-agnostic as possible.</p>
</Footnote>
