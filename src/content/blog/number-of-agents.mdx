...
For better and worse,<FootnoteRef id="read-into-it" /> I use a lot of AI
...
1. Putter
   around.<FootnoteRef id="putter-around" /><Footnote id="putter-around"><p>This
...
Turns out there's a whole framework for analyzing
...
office or something.<FootnoteRef id="idle-games" />

<Footnote id="idle-games">
...
This algorithm optimizes for throughput at your desired utilization level.
If you run fewer agents than it recommends, you will spend more time idling than you wanted.
If you run more, you'll exceed your desired utilization until you reach 100%.
After that, if context switching cost is non-constant, your overall throughput goes down.
...
Combining these through substitution<FootnoteRef id="derivation" /> gives us:
