...
<Note title="🏺 AI disclaimer" id="test">
...
My definition of "selfish AI usage" is:

> A situation in which someone uses an LLM to save their own
> time at the expense of other people's time, resulting in a net
> productivity loss.

Opinions vary on the usefulness of LLMs, but hopefully we can
unanimously agree that using them selfishly is cringe.
...
But it's rude to call people out directly, so the trick is
subtlety. It's not polite to call someone out for blatantly
using AI when their brain would have sufficed. Instead, I
propose a method of subtly shaming people with plausible
deniability:

1. Secretly make fun of people with emoji reactions
...
| Emoji | Emoji name                                                                | Secret meaning                                                                                                            |
| ----- | ------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
...
| 💙    | Blue heart. Blue is typically considered a corporate, tech company color. | This is corporate LLM slop<FootnoteRef number={1} />                                                                      |
...
If you don't mind being fired from your job and/or punched in
the face, respond to slop with the following emojis:
...
| 🏺    | Amphora (Ancient Greek vase) | Authentic human art that will stand for millenia<FootnoteRef number={2}/>                                   |
...
Okay fine, I admit the dog whistle emoji thing is at least 20%
sarcastic. Semi-jokes aside, here are some better things you can
do to shape the world to your liking:
...
## Force the author to defend their slop
...
common tasks is likely under immense time pressure or
sufficiently out of their depth that they lack the ability to
distinguish good from bad content. They are almost certainly not
...
cleaning up after Claude to make the code easier to review:
